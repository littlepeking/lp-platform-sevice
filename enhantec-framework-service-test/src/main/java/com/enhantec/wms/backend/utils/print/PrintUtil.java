...
//          tmpText.concat(dataSource.copyRange(dataSource.getOffset() + 1));
          ...
          try {
              labelData = DBHelper.executeQuery( tmpText, params.toArray(new Object[]{}));
          }catch (Exception e){
    ...
    public static void printLabel( String printer, String labelTempName, String labelName, String copies, String notes, List<Map<String,String>> data, String key) throws Exception {
        ...
        //int TaskID=XtSql.GetSeq( "SEQ_PRINT_TASK");
        ...
        String user = EHContextHelper.getUser().getUsername();
        ...
        try {
            for (int i1 = 0; i1 < data.size(); i1++) {
                ...
                for(int i=0;i<copyNum;i++) {
                    DBHelper.executeUpdate( "Insert Into PRINT_TASK(AddWho,EditWho"
