...
public class UOM {
    ...
    public static BigDecimal UOMQty2StdQty(Context context, Connection conn, String packKey, String uom, BigDecimal uomQty) throws Exception {

        //设置scale=5，否则重量为0时会变成0E-10的数值
        return  getConversionRate2Std(context, conn, packKey,uom).multiply(uomQty).setScale(5);

    }

    public static BigDecimal Std2UOMQty(Context context, Connection conn, String packKey, String uom, BigDecimal stdQty) throws Exception {

        return  stdQty.divide(getConversionRate2Std(context, conn, packKey,uom));

    }


    public static BigDecimal getConversionRate2Std(Context context, Connection conn, String packKey, String uom) throws Exception {

        HashMap<String, String> uomHashMap = getUOMHashMap(context, conn, packKey);
    ...
    public static HashMap<String, String> getUOMHashMap(Context context, Connection conn, String packKey) throws DBResourceException {
        HashMap<String,String> uomHashMap = DBHelper.getRecord(context, conn
    ...
    public static String getStdUOM(Context context, Connection conn, String packKey) throws DBResourceException {
        HashMap<String,String> uomHashMap= getUOMHashMap(context, conn, packKey);
        return uomHashMap.get("PACKUOM3");
    }

    public static String getUOMCode(Context context,String packKey, String uom) {
//
