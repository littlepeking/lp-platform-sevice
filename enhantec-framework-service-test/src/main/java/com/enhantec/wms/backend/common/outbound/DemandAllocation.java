...
public class DemandAllocation {
    ...
    public static List<Map<String, String>> findByOrderLineNumber( String orderkey, String orderLineNumber, boolean checkExist) {
    ...
    public static Map<String, String> findByKey( String demandKey, boolean checkExist) {
