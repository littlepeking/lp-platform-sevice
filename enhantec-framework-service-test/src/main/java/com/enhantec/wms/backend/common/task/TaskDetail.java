...
public class TaskDetail {
    ...
    public static HashMap<String, String> findById(Context context, Connection conn, String id, boolean checkExist) {

        String SQL="select * from taskdetail where TASKDETAILKEY = ?";

        HashMap<String,String> record= DBHelper.getRecord(context, conn, SQL, new Object[]{ id},"任务");
    ...
    public static List<HashMap<String, String>> findByOrderKey(Context context, Connection conn, String orderKey, boolean checkExist) {
        ...
        return DBHelper.executeQuery(context, conn, sql, new Object[]{ orderKey});
