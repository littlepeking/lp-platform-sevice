...
public class CodeLookup {
    ...
    public static String getSysConfig(Context context, String configName) {

        return getCodeLookupValue(context, "SYSSET", configName,"UDF1","仓库系统配置");
    }

    public static String getSysConfig(Context context, String code,String defaultValue)  {

        if(code ==null || code.isEmpty()) ExceptionHelper.throwRfFulfillLogicException("查询系统代码时代码不可以为空");

        List<HashMap<String,String>> list = getCodeLookupList(context, "SYSSET");
    ...
    public static String getCodeLookupValue(Context context, String listName, String key, String field,String errMsg) {


        HashMap<String,String> map = getCodeLookupByKey(context,listName, key);
    ...
    public static HashMap<String,String> getCodeLookupByKey(Context context,String listName,String code,String dbId){
        String sql = "SELECT * FROM "+dbId+".CODELKUP WHERE LISTNAME = ? AND CODE =?";
        HashMap<String, String> record = DBHelper.getRecord(context, sql, new Object[]{listName, code}, "", false);
    ...
    public static HashMap<String,String> getCodeLookupByKey(Context context, String listName, String code){


        if(code ==null || code.isEmpty()) ExceptionHelper.throwRfFulfillLogicException("查询系统代码时代码不可以为空");
        List<HashMap<String,String>> list = getCodeLookupList(context, listName);
    ...
    public static List<HashMap<String,String>> getCodeLookupList(Context context, String listName)  {

        List<HashMap<String,String>> list = DBHelper.executeQuery(context, "select * from codelkup where listname=? ", new Object[]{listName});
        return list;
