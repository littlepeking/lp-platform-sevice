...
public class CodeLookup {
    ...
    public static String getSysConfig( String code,String defaultValue)  {
        ...
        List<Map<String,String>> list = getCodeLookupList( "SYSSET");
    ...
    public static Map<String,String> getCodeLookupByKey(String listName,String code,String dbId){
        String sql = "SELECT * FROM "+dbId+".CODELKUP WHERE LISTNAME = ? AND CODE =?";
        Map<String, String> record = DBHelper.getRecord( sql, new Object[]{listName, code}, "", false);
    ...
    public static Map<String,String> getCodeLookupByKey(String listName, String code){


        if(code ==null || code.isEmpty()) ExceptionHelper.throwRfFulfillLogicException("查询系统代码时代码不可以为空");
        List<Map<String,String>> list = getCodeLookupList(listName);
    ...
    public static List<Map<String,String>> getCodeLookupList( String listName)  {

        List<Map<String,String>> list = DBHelper.executeQuery( "select * from codelkup where listname=? ", new Object[]{listName});
        return list;
