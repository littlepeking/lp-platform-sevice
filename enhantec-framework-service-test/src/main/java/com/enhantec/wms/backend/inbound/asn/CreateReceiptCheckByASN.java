...
import com.enhantec.wms.backend.framework.LegacyBaseService;import com.enhantec.wms.backend.framework.Context;
    ...
    public void execute(com.enhantec.wms.backend.framework.ServiceDataHolder processData)
    {
        ...
        try
        {
            ...
            String isConfirmedUser2 = DBHelper.getValue(context, conn, "SELECT SIGN FROM ESIGNATURE e WHERE SERIALKEY = ? ", new Object[]{
                ...
                String ASNReceiptCheckStatus = CodeLookup.getCodeLookupValue(context,conn,"ASNCHKRES",checkresult,"UDF1","检查结果");
